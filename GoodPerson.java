package com.aliucord.plugins; 
 ...
     List<String> badNounReplacements = Arrays.asList("pasta","kebab","cake","potato","woman","computer","java","hamburger","monster truck","osu!","Ukrainian ball in search of gas game","Anime","Anime girl","good","keyboard","NVIDIA RTX 3090 Graphics Card","storm","queen","single","umbrella","mosque","physics","bath","virus","bathroom","mom","owner","airport","you","mother","Hy-Point Chocolate Milk","Economics","Brand New Animal","Beastars","Vampire Knight","Android 13","John Doe","John Lennon Must Live","Alternate","##########","White","SMART™ Board","Google","run","mobile keyboard","hacker","account disabled","Discord Moderator","egg's  stupidity","###","###############################","Ukraine","my mom is on yours","Google Assistant","Destiny 2",":cloud_lightning:","invalid","nah",".gif","Google Voice Typing","I love you","trolled","##########","Im A Good Person","Commit Fortnite run on IOS","sease to exsist"); 
